...
if __name__ == "__main__":
    ...
    "RandomForestRegressor": (
        ...
        "RS42_consensus_n7_fast_aggr_False_RandomForestRegressor_model.pkl"
    ),
    "XGBoost": (
        "../Results/Trained_Models/"
        "RS42_consensus_n7_fast_aggr_False_XGBoost_model.pkl"
    ),
    "GradientBoosting": (
        "../Results/Trained_Models/"
        "RS42_consensus_n7_fast_aggr_False_GradientBoosting_model.pkl"
    ),
    "Ridge": (
        "../Results/Trained_Models/"
        "RS42_consensus_n7_fast_aggr_False_Ridge_model.pkl"
    ),
    "DecisionTree": (
        "../Results/Trained_Models/"
        "RS42_consensus_n7_fast_aggr_False_DecisionTree_model.pkl"
    ),
    "KNN": (
        "../Results/Trained_Models/"
        "RS42_consensus_n7_fast_aggr_False_KNN_model.pkl"
    ),
    "SVR": (
        "../Results/Trained_Models/"
        "RS42_consensus_n7_fast_aggr_False_SVR_model.pkl"
    ),
    }
