...
class AdvancedFeatureSelector:
    ...
    def _permutation_importance_cv_safe(self, n_features=15, model=None):
        ...
        for i, (train_idx, val_idx) in enumerate(kf.split(self.X_scaled), 1):
    ...
    def _rfe_selection_cv_safe(self, n_features=15):
        ...
        splits = list(cv.split(self.X_scaled))
...
def prepare_model(X_train, X_test, y_train, y_test,
    ...
    # Statistical test
    ts_stats = RigorousValidator.statistical_test(test_rmse, null_dist) ##test_mae
...
class RigorousValidator:
    ...
    @staticmethod
    def statistical_test(our_rmse, null_rmse_dist): ###our_mae, null_mae_dist
        ...
        # We add 1 to num and den to avoid p=0 (Laplace smoothing / conservative estimate)
