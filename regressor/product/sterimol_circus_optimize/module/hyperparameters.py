...
class HyperparametersConfig:
    ...
    SVM = {
            'C': [0.001, 0.01, 0.1, 0.5, 1, 2, 5, 10, 15, 20, 50, 100],
            'kernel': ['linear', 'rbf'],
            'gamma': ['scale', 'auto', 0.001, 0.01, 0.1, 1.0, 10],
            'epsilon': [0.001, 0.01, 0.1, 0.2, 0.3, 0.5],
    }
   
    RIDGE_REGRESSION = {
            'alpha': [0.01, 0.1, 0.5, 1, 2, 5, 10, 20, 50, 100, 150, 200],
            'solver': ['auto'],
