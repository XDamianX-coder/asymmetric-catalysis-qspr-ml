...
if __name__ == "__main__":
    ...
    PRESELECTED_FEATURES = ['CircuS_r1-3_ccc', 'CircuS_r1-3_ccc(cc)/C=C/C(=O)C',
                            'CircuS_r1-3_c1ccccc1/C=C/C', 'Sterimol_Beta_R1_L'
                            ] ## 6 fast aggr
    #    4 KNN fast aggr PRESELECTED_FEATURES = [
        #'CircuS_r1-3_ccc', 'CircuS_r1-3_ccc(cc)/C=C/C(=O)C',
       #'CircuS_r1-3_c1ccccc1/C=C/C', 'Sterimol_Beta_R1_L'
    #] 
    #['CircuS_r1-3_ccc(cc)/C=C/C(=O)C',
                #            'CircuS_r1-3_ccc',
                  #          'CircuS_r1-3_cc(c)/C=C/C(=O)c(c)c',
                   #         'CircuS_r1-3_c1ccccc1/C=C/C',
                   #         'CircuS_r1-3_ccc(cc)C=C',
                      #      'Sterimol_Beta_R1_L'] ## 6 fast aggr
#
    print("\n" + "═"*80)
